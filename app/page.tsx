...
const managedTaxes: { description: string; name: string }[] = [
  {
    name: "PBB-P2",
    description:
  ...
  return (
    <article className="typography container mx-auto flex flex-col">
      <section className="flex min-h-[calc(100svh-(var(--spacing)*16))] flex-col justify-center">
        ...
        <div className="mx-auto mt-6 flex max-w-full flex-col flex-wrap items-center justify-center gap-2 sm:flex-row">
          <ButtonGroup>
          ...
          <ButtonGroup className="max-w-full">
            ...
            <Button className="min-w-0" variant="outline">
              <span className="truncate font-mono">100.000.000.000</span>
      ...
      <section>
        <span className="flex items-center justify-center gap-3">
          ...
          <Badge className="font-mono">{managedTaxes.length}</Badge>
        </span>
        <div className="not-typography divide mt-8 grid grid-cols-1 divide-x divide-y overflow-clip rounded-md border md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="group relative cursor-pointer space-y-2 bg-primary p-6 text-primary-foreground transition-colors duration-300 hover:border-primary hover:bg-primary/90">
            ...
            <Link className="absolute inset-0" href="/kontak">
              <span className="sr-only">Hubungi BAPENDA Garut</span>
            </Link>
          </div>
        </div>
      </section>
